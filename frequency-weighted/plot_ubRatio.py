...
plt.plot(optlcms_filtered["Memory Usage"], optlcms_filtered["UB Memmory Ratio"], label="Ours", marker='s',linestyle='-',color='#2ca02c',linewidth = 3.0, markersize=14)
...
plt.legend()
plt.savefig("img/ub-memory-ratio-eq-frequency-weighted.svg",dpi=600,format='svg',bbox_inches="tight")
